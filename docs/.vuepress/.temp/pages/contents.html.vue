...
<ul>
<li>Guidelines and standards to follow when contributing to the codebase.</li>
</ul>
</li>
<li>
<p><a href="#coding-conventions">Coding Conventions</a></p>
<ul>
<li>Best practices for writing clean and maintainable code.</li>
<li><a href="#indentation-and-spacing">Indentation and Spacing</a>
<ul>
<li>Rules for indentation, spacing, and line breaks.</li>
</ul>
</li>
<li><a href="#commenting">Commenting</a>
<ul>
<li>Guidelines for writing comments in the code.</li>
</ul>
</li>
</ul>
</li>
<li>
<p><a href="#abstraction-and-dependencies">Abstraction and Dependencies</a></p>
<ul>
<li>Principles for managing dependencies and abstracting components.</li>
</ul>
</li>
<li>
<p><a href="#naming-conventions">Naming Conventions</a></p>
<ul>
<li>Rules for naming variables, functions, classes, and files.</li>
<li><a href="#variable-naming">Variable Naming</a>
<ul>
<li>Conventions for naming variables.</li>
</ul>
</li>
<li><a href="#function-naming">Function Naming</a>
<ul>
<li>Conventions for naming functions.</li>
</ul>
</li>
<li><a href="#class-naming">Class Naming</a>
<ul>
<li>Conventions for naming classes.</li>
</ul>
</li>
</ul>
</li>
...
<ul>
<li>Standards for declaring functions.</li>
<li><a href="#return-types">Return Types</a>
<ul>
<li>Guidelines for choosing and specifying return types.</li>
</ul>
</li>
<li><a href="#parameters">Parameters</a>
<ul>
<li>Rules for naming and ordering function parameters.</li>
</ul>
</li>
</ul>
</li>
<li>
<p><a href="#struct-declarations">Struct Declarations</a></p>
<ul>
<li>Standards for declaring and using structs.</li>
</ul>
</li>
<li>
...
<ul>
<li>Rules for template specialization and partial specialization.</li>
</ul>
</li>
<li><a href="#template-parameters">Template Parameters</a>
<ul>
<li>Guidelines for naming and ordering template parameters.</li>
</ul>
</li>
</ul>
<ol start="11">
